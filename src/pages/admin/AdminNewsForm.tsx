...
import { ArrowLeft, Loader2, Save, Eye, FileText, X, CalendarIcon, Clock, Share2 } from "lucide-react";
  ...
  useEffect(() => {
    if (newsItem) {
      form.reset({
        ...
        scheduled_at: (newsItem as any).scheduled_at ? new Date((newsItem as any).scheduled_at) : null,
        scheduled_crosspost: (newsItem as any).scheduled_crosspost ?? true,
      });
    }
  }, [newsItem, form]);
                        ...
                        render={({ field }) => {
                          ...
                          return (
                            <FormItem className="flex flex-col">
                              ...
                              <FormDescription>
                                Новость автоматически опубликуется в указанное время
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
                          );
